...
%token LPAREN RPAREN LBRACE RBRACE SEMI ASSIGN LET AS INPUT OUTPUT
%token<str_val> ID
...
declaration: LET ID AS INT ASSIGN INPUT LPAREN RPAREN SEMI
            {
                insert($2, $4);
            }
            | LET ID AS INT ASSIGN exp SEMI
            ;
